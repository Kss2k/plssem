# Modified code, written by Florian Schubert
# REPO: https://github.com/FloSchuberth/cSEM/
# FILE: R/helper_estimators_paths.R
# COMMENT: I couldn't be bothered to write all this my self
#          it's just too much...
...
classifyConstructs <- function(.terms) {
  ...
  terms_classified <- lapply(terms_split, function(.x) {
    ...
    if(a > 3) {
      pls_msg_stop(paste0("The nonlinear term(s): ", paste0("`", .terms, "`", collapse = ", "),
